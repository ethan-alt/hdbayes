...
namespace model_glm_robustmap_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_glm_robustmap");
    ...
    reader.add_event(39, 2, "restart", "model_glm_robustmap");
    reader.add_event(98, 59, "end", "model_glm_robustmap");
    return reader;
}
...
class model_glm_robustmap
  : public stan::model::model_base_crtp<model_glm_robustmap> {
private:
        int n;
        int n0;
        int p;
        ...
        vector_d y0;
        matrix_d X0;
        vector_d coef_hp_mean;
        matrix_d coef_hp_cov;
        vector_d coef_vague_mean;
        matrix_d coef_vague_cov;
        int iw_hp_df;
        matrix_d iw_hp_scale;
        double disp_shape;
        double disp_scale;
        double disp0_shape;
        double disp0_scale;
        ...
        double log1mw;
public:
    model_glm_robustmap(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_glm_robustmap_namespace::model_glm_robustmap";
        ...
        try {
            ...
            validate_non_negative_index("coef_hp_mean", "p", p);
            context__.validate_dims("data initialization", "coef_hp_mean", "vector_d", context__.to_vec(p));
            coef_hp_mean = Eigen::Matrix<double, Eigen::Dynamic, 1>(p);
            vals_r__ = context__.vals_r("coef_hp_mean");
            pos__ = 0;
            size_t coef_hp_mean_j_1_max__ = p;
            for (size_t j_1__ = 0; j_1__ < coef_hp_mean_j_1_max__; ++j_1__) {
                coef_hp_mean(j_1__) = vals_r__[pos__++];
            }
            current_statement_begin__ = 50;
            validate_non_negative_index("coef_hp_cov", "p", p);
            validate_non_negative_index("coef_hp_cov", "p", p);
            context__.validate_dims("data initialization", "coef_hp_cov", "matrix_d", context__.to_vec(p,p));
            coef_hp_cov = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(p, p);
            vals_r__ = context__.vals_r("coef_hp_cov");
            pos__ = 0;
            size_t coef_hp_cov_j_2_max__ = p;
            size_t coef_hp_cov_j_1_max__ = p;
            for (size_t j_2__ = 0; j_2__ < coef_hp_cov_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < coef_hp_cov_j_1_max__; ++j_1__) {
                    coef_hp_cov(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            current_statement_begin__ = 51;
            validate_non_negative_index("coef_vague_mean", "p", p);
            context__.validate_dims("data initialization", "coef_vague_mean", "vector_d", context__.to_vec(p));
            coef_vague_mean = Eigen::Matrix<double, Eigen::Dynamic, 1>(p);
            vals_r__ = context__.vals_r("coef_vague_mean");
            pos__ = 0;
            size_t coef_vague_mean_j_1_max__ = p;
            for (size_t j_1__ = 0; j_1__ < coef_vague_mean_j_1_max__; ++j_1__) {
                coef_vague_mean(j_1__) = vals_r__[pos__++];
            }
            current_statement_begin__ = 52;
            validate_non_negative_index("coef_vague_cov", "p", p);
            validate_non_negative_index("coef_vague_cov", "p", p);
            context__.validate_dims("data initialization", "coef_vague_cov", "matrix_d", context__.to_vec(p,p));
            coef_vague_cov = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(p, p);
            vals_r__ = context__.vals_r("coef_vague_cov");
            pos__ = 0;
            size_t coef_vague_cov_j_2_max__ = p;
            size_t coef_vague_cov_j_1_max__ = p;
            for (size_t j_2__ = 0; j_2__ < coef_vague_cov_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < coef_vague_cov_j_1_max__; ++j_1__) {
                    coef_vague_cov(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            current_statement_begin__ = 53;
            context__.validate_dims("data initialization", "iw_hp_df", "int", context__.to_vec());
            iw_hp_df = int(0);
            vals_i__ = context__.vals_i("iw_hp_df");
            pos__ = 0;
            iw_hp_df = vals_i__[pos__++];
            check_greater_or_equal(function__, "iw_hp_df", iw_hp_df, 0);
            current_statement_begin__ = 54;
            validate_non_negative_index("iw_hp_scale", "p", p);
            validate_non_negative_index("iw_hp_scale", "p", p);
            context__.validate_dims("data initialization", "iw_hp_scale", "matrix_d", context__.to_vec(p,p));
            iw_hp_scale = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(p, p);
            vals_r__ = context__.vals_r("iw_hp_scale");
            pos__ = 0;
            size_t iw_hp_scale_j_2_max__ = p;
            size_t iw_hp_scale_j_1_max__ = p;
            for (size_t j_2__ = 0; j_2__ < iw_hp_scale_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < iw_hp_scale_j_1_max__; ++j_1__) {
                    iw_hp_scale(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            ...
            context__.validate_dims("data initialization", "w", "double", context__.to_vec());
            w = double(0);
            vals_r__ = context__.vals_r("w");
            pos__ = 0;
            w = vals_r__[pos__++];
            check_greater_or_equal(function__, "w", w, 0.000001);
            check_less_or_equal(function__, "w", w, 0.999999);
            ...
            log1mw = double(0);
            stan::math::fill(log1mw, DUMMY_VAR__);
            stan::math::assign(log1mw,log1m(w));
            ...
            validate_non_negative_index("coef_mean", "p", p);
            num_params_r__ += p;
            current_statement_begin__ = 73;
            validate_non_negative_index("coef_cov", "p", p);
            validate_non_negative_index("coef_cov", "p", p);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 72;
        if (!(context__.contains_r("coef_mean")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable coef_mean missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("coef_mean");
        pos__ = 0U;
        validate_non_negative_index("coef_mean", "p", p);
        context__.validate_dims("parameter initialization", "coef_mean", "vector_d", context__.to_vec(p));
        Eigen::Matrix<double, Eigen::Dynamic, 1> coef_mean(p);
        size_t coef_mean_j_1_max__ = p;
        for (size_t j_1__ = 0; j_1__ < coef_mean_j_1_max__; ++j_1__) {
            coef_mean(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(coef_mean);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable coef_mean: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 73;
        if (!(context__.contains_r("coef_cov")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable coef_cov missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("coef_cov");
        pos__ = 0U;
        validate_non_negative_index("coef_cov", "p", p);
        validate_non_negative_index("coef_cov", "p", p);
        context__.validate_dims("parameter initialization", "coef_cov", "matrix_d", context__.to_vec(p,p));
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> coef_cov(p, p);
        size_t coef_cov_j_2_max__ = p;
        size_t coef_cov_j_1_max__ = p;
        for (size_t j_2__ = 0; j_2__ < coef_cov_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < coef_cov_j_1_max__; ++j_1__) {
                coef_cov(j_1__, j_2__) = vals_r__[pos__++];
            }
        }
        try {
            writer__.cov_matrix_unconstrain(coef_cov);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable coef_cov: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 74;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 72;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> coef_mean;
            (void) coef_mean;  // dummy to suppress unused var warning
            if (jacobian__)
                coef_mean = in__.vector_constrain(p, lp__);
            else
                coef_mean = in__.vector_constrain(p);
            current_statement_begin__ = 73;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, Eigen::Dynamic> coef_cov;
            (void) coef_cov;  // dummy to suppress unused var warning
            if (jacobian__)
                coef_cov = in__.cov_matrix_constrain(p, lp__);
            else
                coef_cov = in__.cov_matrix_constrain(p);
            current_statement_begin__ = 74;
            ...
            lp_accum__.add(multi_normal_log<propto__>(beta0, coef_mean, coef_cov));
            current_statement_begin__ = 79;
            lp_accum__.add(multi_normal_log<propto__>(coef_mean, coef_hp_mean, coef_hp_cov));
            current_statement_begin__ = 80;
            lp_accum__.add(inv_wishart_log<propto__>(coef_cov, iw_hp_df, iw_hp_scale));
            current_statement_begin__ = 82;
            lp_accum__.add(log_sum_exp((logw + multi_normal_log(beta, coef_mean, coef_cov)), (log1mw + multi_normal_log(beta, coef_vague_mean, coef_vague_cov))));
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("coef_mean");
        names__.push_back("coef_cov");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_glm_robustmap_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> coef_mean = in__.vector_constrain(p);
        size_t coef_mean_j_1_max__ = p;
        for (size_t j_1__ = 0; j_1__ < coef_mean_j_1_max__; ++j_1__) {
            vars__.push_back(coef_mean(j_1__));
        }
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> coef_cov = in__.cov_matrix_constrain(p);
        size_t coef_cov_j_2_max__ = p;
        size_t coef_cov_j_1_max__ = p;
        for (size_t j_2__ = 0; j_2__ < coef_cov_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < coef_cov_j_1_max__; ++j_1__) {
                vars__.push_back(coef_cov(j_1__, j_2__));
            }
        }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < coef_mean_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "coef_mean" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t coef_cov_j_2_max__ = p;
        size_t coef_cov_j_1_max__ = p;
        for (size_t j_2__ = 0; j_2__ < coef_cov_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < coef_cov_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "coef_cov" << '.' << j_1__ + 1 << '.' << j_2__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        size_t dispersion_k_0_max__ = (logical_gt(dist, 2) ? 1 : 0 );
    ...
    void unconstrained_param_names(std::vector<std::string>& param_names__,
        ...
        size_t coef_cov_j_1_max__ = (p + ((p * (p - 1)) / 2));
        for (size_t j_1__ = 0; j_1__ < coef_cov_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "coef_cov" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t dispersion_k_0_max__ = (logical_gt(dist, 2) ? 1 : 0 );
        for (size_t k_0__ = 0; k_0__ < dispersion_k_0_max__; ++k_0__) {
...
typedef model_glm_robustmap_namespace::model_glm_robustmap stan_model;
#ifndef USING_R
