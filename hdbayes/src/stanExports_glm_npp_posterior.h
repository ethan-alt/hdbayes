...
namespace model_glm_npp_posterior_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_glm_npp_posterior");
    ...
    reader.add_event(39, 2, "restart", "model_glm_npp_posterior");
    reader.add_event(39, 2, "include", "include/finda0closest.stan");
    reader.add_event(39, 0, "start", "include/finda0closest.stan");
    reader.add_event(95, 56, "end", "include/finda0closest.stan");
    reader.add_event(95, 3, "restart", "model_glm_npp_posterior");
    reader.add_event(147, 53, "end", "model_glm_npp_posterior");
    return reader;
}
...
pp_lognc(const T0__& a0,
             const Eigen::Matrix<T1__, Eigen::Dynamic, 1>& a0vec,
             const Eigen::Matrix<T2__, Eigen::Dynamic, 1>& lognca0, std::ostream* pstream__) {
...
struct pp_lognc_functor__ {
    ...
    operator()(const T0__& a0,
             const Eigen::Matrix<T1__, Eigen::Dynamic, 1>& a0vec,
             const Eigen::Matrix<T2__, Eigen::Dynamic, 1>& lognca0, std::ostream* pstream__) const {
        return pp_lognc(a0, a0vec, lognca0, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_glm_npp_posterior
  : public stan::model::model_base_crtp<model_glm_npp_posterior> {
private:
        int n;
        int n0;
        int p;
        ...
        vector_d offset0;
public:
    model_glm_npp_posterior(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_glm_npp_posterior_namespace::model_glm_npp_posterior";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "beta_mean", "vector_d", context__.to_vec(p));
            beta_mean = Eigen::Matrix<double, Eigen::Dynamic, 1>(p);
            ...
            validate_non_negative_index("beta_cov", "p", p);
            context__.validate_dims("data initialization", "beta_cov", "matrix_d", context__.to_vec(p,p));
            beta_cov = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(p, p);
            ...
            validate_non_negative_index("a0_vec", "k", k);
            context__.validate_dims("data initialization", "a0_vec", "vector_d", context__.to_vec(k));
            a0_vec = Eigen::Matrix<double, Eigen::Dynamic, 1>(k);
            vals_r__ = context__.vals_r("a0_vec");
            pos__ = 0;
            size_t a0_vec_j_1_max__ = k;
            for (size_t j_1__ = 0; j_1__ < a0_vec_j_1_max__; ++j_1__) {
                a0_vec(j_1__) = vals_r__[pos__++];
            }
            check_greater_or_equal(function__, "a0_vec", a0_vec, 0);
            check_less_or_equal(function__, "a0_vec", a0_vec, 1);
            current_statement_begin__ = 111;
            validate_non_negative_index("lognca0_vec", "k", k);
            context__.validate_dims("data initialization", "lognca0_vec", "vector_d", context__.to_vec(k));
            lognca0_vec = Eigen::Matrix<double, Eigen::Dynamic, 1>(k);
            vals_r__ = context__.vals_r("lognca0_vec");
            pos__ = 0;
            size_t lognca0_vec_j_1_max__ = k;
            for (size_t j_1__ = 0; j_1__ < lognca0_vec_j_1_max__; ++j_1__) {
                lognca0_vec(j_1__) = vals_r__[pos__++];
            }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_lte(dist, 2))) {
                ...
                lp_accum__.add((a0 * glm_lp(y0, beta, 1.0, X0, dist, link, offset0, lp__, lp_accum__, pstream__)));
            } else {
            ...
            lp_accum__.add(-(pp_lognc(a0, a0_vec, lognca0_vec, pstream__)));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_glm_npp_posterior_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_glm_npp_posterior";
    }
...
typedef model_glm_npp_posterior_namespace::model_glm_npp_posterior stan_model;
#ifndef USING_R
