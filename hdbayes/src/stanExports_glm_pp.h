...
namespace model_glm_pp_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_glm_pp");
    ...
    reader.add_event(39, 2, "restart", "model_glm_pp");
    reader.add_event(77, 38, "end", "model_glm_pp");
    return reader;
}
...
class model_glm_pp
  : public stan::model::model_base_crtp<model_glm_pp> {
private:
        int n;
        int n0;
        int p;
        ...
        vector_d offset0;
public:
    model_glm_pp(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_glm_pp_namespace::model_glm_pp";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_lte(dist, 2))) {
                ...
                lp_accum__.add(multi_normal_log<propto__>(beta, mean_beta, cov_beta));
            } else {
                ...
                lp_accum__.add(multi_normal_log<propto__>(beta, mean_beta, multiply(get_base1(dispersion, 1, "dispersion", 1), cov_beta)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_glm_pp_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_glm_pp_namespace::model_glm_pp stan_model;
#ifndef USING_R
