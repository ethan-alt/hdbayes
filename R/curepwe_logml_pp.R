...
#' data set.
#'
#' @include curepwe_logml_post.R
#' @include curepwe_pp_lognc.R
#'
#' @export
#'
#' @param post.samples      output from [curepwe.pp()] giving posterior samples of a CurePWE model under the power prior (PP),
...
curepwe.logml.pp = function(
  ...
  fit = curepwe_pp_prior$sample(data = stan.data,
