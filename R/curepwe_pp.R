...
#' parameters with half-normal priors. Additionally, a normal prior is specified for the logit of the cure fraction \eqn{\pi}.
#'
...
curepwe.pp = function(
  ...
  curepwe_pp = instantiate::stan_package_model(
    name = "curepwe_pp",
    package = "hdbayes"
  )

  ## fit model in cmdstanr
  fit = curepwe_pp$sample(data = standat,
  ...
  attr(x = d, which = 'model') = "curepwe_pp"
  return(d)
}
