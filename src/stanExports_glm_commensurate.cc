...
#include "stanExports_glm_commensurate.h"

RCPP_MODULE(stan_fit4glm_commensurate_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_glm_commensurate")
