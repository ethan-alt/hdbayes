...
#include "stanExports_glm_npp_posterior.h"

RCPP_MODULE(stan_fit4glm_npp_posterior_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_glm_npp_posterior")
