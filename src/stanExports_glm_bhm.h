...
namespace model_glm_bhm_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_glm_bhm");
    ...
    reader.add_event(39, 2, "restart", "model_glm_bhm");
    reader.add_event(87, 48, "end", "model_glm_bhm");
    return reader;
}
...
class model_glm_bhm
  : public stan::model::model_base_crtp<model_glm_bhm> {
private:
        int n;
        int n0;
        int p;
        ...
        vector_d y0;
        matrix_d X0;
        vector_d hp_norm_mean;
        matrix_d hp_norm_cov;
        int hp_iw_df;
        matrix_d hp_iw_scale;
        double disp0_shape;
        double disp0_scale;
        double disp_shape;
        double disp_scale;
        ...
        vector_d offset0;
public:
    model_glm_bhm(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_glm_bhm_namespace::model_glm_bhm";
        ...
        try {
            ...
            validate_non_negative_index("hp_norm_mean", "p", p);
            context__.validate_dims("data initialization", "hp_norm_mean", "vector_d", context__.to_vec(p));
            hp_norm_mean = Eigen::Matrix<double, Eigen::Dynamic, 1>(p);
            vals_r__ = context__.vals_r("hp_norm_mean");
            pos__ = 0;
            size_t hp_norm_mean_j_1_max__ = p;
            for (size_t j_1__ = 0; j_1__ < hp_norm_mean_j_1_max__; ++j_1__) {
                hp_norm_mean(j_1__) = vals_r__[pos__++];
            }
            current_statement_begin__ = 50;
            validate_non_negative_index("hp_norm_cov", "p", p);
            validate_non_negative_index("hp_norm_cov", "p", p);
            context__.validate_dims("data initialization", "hp_norm_cov", "matrix_d", context__.to_vec(p,p));
            hp_norm_cov = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(p, p);
            vals_r__ = context__.vals_r("hp_norm_cov");
            pos__ = 0;
            size_t hp_norm_cov_j_2_max__ = p;
            size_t hp_norm_cov_j_1_max__ = p;
            for (size_t j_2__ = 0; j_2__ < hp_norm_cov_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < hp_norm_cov_j_1_max__; ++j_1__) {
                    hp_norm_cov(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            current_statement_begin__ = 51;
            context__.validate_dims("data initialization", "hp_iw_df", "int", context__.to_vec());
            hp_iw_df = int(0);
            vals_i__ = context__.vals_i("hp_iw_df");
            pos__ = 0;
            hp_iw_df = vals_i__[pos__++];
            check_greater_or_equal(function__, "hp_iw_df", hp_iw_df, 0);
            current_statement_begin__ = 52;
            validate_non_negative_index("hp_iw_scale", "p", p);
            validate_non_negative_index("hp_iw_scale", "p", p);
            context__.validate_dims("data initialization", "hp_iw_scale", "matrix_d", context__.to_vec(p,p));
            hp_iw_scale = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(p, p);
            vals_r__ = context__.vals_r("hp_iw_scale");
            pos__ = 0;
            size_t hp_iw_scale_j_2_max__ = p;
            size_t hp_iw_scale_j_1_max__ = p;
            for (size_t j_2__ = 0; j_2__ < hp_iw_scale_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < hp_iw_scale_j_1_max__; ++j_1__) {
                    hp_iw_scale(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            ...
            validate_non_negative_index("beta_mean", "p", p);
            num_params_r__ += p;
            current_statement_begin__ = 68;
            validate_non_negative_index("beta_cov", "p", p);
            validate_non_negative_index("beta_cov", "p", p);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("beta_mean")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable beta_mean missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("beta_mean");
        pos__ = 0U;
        validate_non_negative_index("beta_mean", "p", p);
        context__.validate_dims("parameter initialization", "beta_mean", "vector_d", context__.to_vec(p));
        Eigen::Matrix<double, Eigen::Dynamic, 1> beta_mean(p);
        size_t beta_mean_j_1_max__ = p;
        for (size_t j_1__ = 0; j_1__ < beta_mean_j_1_max__; ++j_1__) {
            beta_mean(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(beta_mean);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable beta_mean: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 68;
        if (!(context__.contains_r("beta_cov")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable beta_cov missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("beta_cov");
        pos__ = 0U;
        validate_non_negative_index("beta_cov", "p", p);
        validate_non_negative_index("beta_cov", "p", p);
        context__.validate_dims("parameter initialization", "beta_cov", "matrix_d", context__.to_vec(p,p));
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> beta_cov(p, p);
        size_t beta_cov_j_2_max__ = p;
        size_t beta_cov_j_1_max__ = p;
        for (size_t j_2__ = 0; j_2__ < beta_cov_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < beta_cov_j_1_max__; ++j_1__) {
                beta_cov(j_1__, j_2__) = vals_r__[pos__++];
            }
        }
        try {
            writer__.cov_matrix_unconstrain(beta_cov);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable beta_cov: ") + e.what()), current_statement_begin__, prog_reader__());
        }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 67;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> beta_mean;
            (void) beta_mean;  // dummy to suppress unused var warning
            if (jacobian__)
                beta_mean = in__.vector_constrain(p, lp__);
            else
                beta_mean = in__.vector_constrain(p);
            current_statement_begin__ = 68;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, Eigen::Dynamic> beta_cov;
            (void) beta_cov;  // dummy to suppress unused var warning
            if (jacobian__)
                beta_cov = in__.cov_matrix_constrain(p, lp__);
            else
                beta_cov = in__.cov_matrix_constrain(p);
            // model body
            current_statement_begin__ = 71;
            lp_accum__.add(multi_normal_log<propto__>(beta, beta_mean, beta_cov));
            current_statement_begin__ = 72;
            lp_accum__.add(multi_normal_log<propto__>(beta0, beta_mean, beta_cov));
            current_statement_begin__ = 73;
            lp_accum__.add(multi_normal_log<propto__>(beta_mean, hp_norm_mean, hp_norm_cov));
            current_statement_begin__ = 74;
            lp_accum__.add(inv_wishart_log<propto__>(beta_cov, hp_iw_df, hp_iw_scale));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_glm_bhm_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> beta_mean = in__.vector_constrain(p);
        size_t beta_mean_j_1_max__ = p;
        for (size_t j_1__ = 0; j_1__ < beta_mean_j_1_max__; ++j_1__) {
            vars__.push_back(beta_mean(j_1__));
        }
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> beta_cov = in__.cov_matrix_constrain(p);
        size_t beta_cov_j_2_max__ = p;
        size_t beta_cov_j_1_max__ = p;
        for (size_t j_2__ = 0; j_2__ < beta_cov_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < beta_cov_j_1_max__; ++j_1__) {
                vars__.push_back(beta_cov(j_1__, j_2__));
            }
        }
        double lp__ = 0.0;
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < beta_mean_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "beta_mean" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t beta_cov_j_2_max__ = p;
        size_t beta_cov_j_1_max__ = p;
        for (size_t j_2__ = 0; j_2__ < beta_cov_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < beta_cov_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "beta_cov" << '.' << j_1__ + 1 << '.' << j_2__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        if (!include_gqs__ && !include_tparams__) return;
    ...
    void unconstrained_param_names(std::vector<std::string>& param_names__,
        ...
        size_t beta_cov_j_1_max__ = (p + ((p * (p - 1)) / 2));
        for (size_t j_1__ = 0; j_1__ < beta_cov_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
...
typedef model_glm_bhm_namespace::model_glm_bhm stan_model;
#ifndef USING_R
