...
vignette: >
  ...
  %\VignetteDepends{parallel, posterior, ggplot2, ggthemes, tibble, wacolors, tidyverse}
---
...
ncores <- 2 # increase to match your computing power
...
```{r compsetup, cache = FALSE}
nchains <- 4
warmup  <- 1000
total.samples <- 10000   ## number of samples post warmup
samples <- ceiling( total.samples / nchains)  ## outputs approx total.samples samples
...
```{r a0prior, cache = FALSE, fig.align='center', fig.height=4, fig.width=8, fig.fullwidth=TRUE}
