...
methods that leverage historical data. The `hdbayes` package depends on the R package [`instantiate`](https://wlandau.github.io/instantiate/) to build pre-compiled 
CmdStan models.
...
We now simulate some logistic regression data. For simplicity, we generate one 
