...
You can install the latest version of `hdbayes` package on CRAN using the following R command:
...
Alternatively, you can install the development version of `hdbayes` from GitHub via
